...
Para correr a aplicação web, é necessário descomprimir o ficheiro src.zip na pasta de destino do gnomo em public_html/
...
./configure.sh "~upxxxxxxxxx" em que upxxxxxxxxx representa o nome da conta. 
...
devem ser alterados manualmente, substituindo a string BASE_DIR_PLACEHOLDER por /~upxxxxxxxxx (não esquecer a / inicial)

Para correr a aplicação localmente, o BASE_DIR_PLACEHOLDER deve ser uma string vazia

------------------------------------------------------

A aplicação tem alguns utilizadores previamente criados, como testuser e testuser2, ambos com password = 'password123'.
